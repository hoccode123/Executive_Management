...
router.post('/created', async (req, res) => {
    ...
    const {userCode, fullName,avatar, email, phone, active, gender, createnew, departmentID, roleID, createByID} = req.body
    ...
    // const check_password_format = Class_Admin.check_password_format(password)
    // if(check_password_format!='') return check_password_format

    // const check_password_distance = Class_Admin.check_password_distance(password)
    // if(check_password_distance!='') return check_password_distance

    // const check_re_password_compare = Class_Admin.check_compare(password,re_password)
    // if(check_re_password_compare!='') return check_re_password_compare
...
//     const {userCode, fullName, avatar, email, phone, active, gender, new, departmentID, roleID, createDate, updateDate, createByID, updateByID } = req.body

//     const data = await userModels.find()
//     .exec((err, data) => {({userCode, fullName, avatar, email, phone, active, gender, new, departmentID, roleID, createDate, updateDate, createByID, updateByID})
//     response(res, 200, data)
//     })
// })
